...
public class ThirdAgent extends Agent  {
	 ...
	 */
		...
		protected void setup () {
			...
			addBehaviour(new WnCyclicBehaviour(this));
	...
	class WnCyclicBehaviour extends CyclicBehaviour
	{
		ThirdAgent agent;
		public WnCyclicBehaviour(ThirdAgent agent)
		{
			this.agent = agent;
		}
		public void action()
		{
			MessageTemplate template = MessageTemplate.MatchOntology("newthird");
